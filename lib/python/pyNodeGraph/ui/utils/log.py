# -*- coding: utf-8 -*-
from pyNodeGraph.module.sqt import QtWidgets, QtGui, QtCore
...
class LogWindow(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.setWindowTitle('Py Node Graph Log')
...
def getLogWindow():
    ...
    if not LOG_WINDOW:
        logWindow = LogWindow()
        PY_NODE_GRAPH_WINDOW.mainWindowClosed.connect(logWindow.close)
    return LOG_WINDOW
